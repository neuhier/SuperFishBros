...
class Player(object):
     ...
     def update(self, direction):
        ...
        if self.rect.right > game.game_width:
            self.rect.right = game.game_width
        if self.rect.top <= 0:
            self.rect.top = 0
        if self.rect.bottom >= game.game_height:
            self.rect.bottom = game.game_height        
